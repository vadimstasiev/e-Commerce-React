...
const ItemCard = ({product}) => {
  return (
    <div className="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden dark:bg-black/[.3] relative">
        <div className="flex items-end justify-end h-56 w-full bg-cover bg-center " style={{backgroundImage: `url("${product.imagesUploadedUrl[0]}")`}}>
            <button className="p-2 rounded-full bg-gray-200 text-white mx-5 -mb-4 hover:bg-gray-300 focus:outline-none focus:bg-gray-500">
