...
const FAQ = () => {
    return (
        ...
        <div className="my-40 font-display">
            <div className="">
                <div>
                    <div className="opacity-75">
                        <svg className="w-1/2 max-w-screen-sm mx-auto" xmlns="http://www.w3.org/2000/svg" id="ffb55883-6880-4c99-84fd-4a8eccb5f463" data-name="Layer 1" viewBox="0 0 887.5 444.00977">
                            <title>Frequently Asqued Questions</title>
            ...
            <div className="hidden treact-popup fixed inset-0 flex items-center justify-center">
