          ...
          <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
            ...
            <div className="order-2 md:order-3 flex items-center" id="nav-content">
              <a className="inline-block" href="#">
                <svg className="fill-current dark:text-gray-200 hover:text-black dark:hover:text-white" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24">
              ...
              <a className="inline-block pl-2" href="#">
                <Toggle customClass="text-gray-700 dark:text-gray-200 hover:text-black dark:hover:text-white text-xl"/>
              </a>
            </div>
          </div>
        </nav>
