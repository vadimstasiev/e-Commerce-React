        ...
        <nav id="header" className=" w-full top-0">
          ...
          <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3 pt-4">     
            ...
            <div className="lg:order-4 order-6">
              <a onClick={() => navigate(`/`)} className="flex items-center tracking-wide no-underline hover:no-underline font-bold text-xl text-zinc-800 dark:text-zinc-100 hover:text-black dark:hover:text-white" >
