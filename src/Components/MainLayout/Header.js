            ...
            <>
              ...
              >
                ...
                {user?
                  <Menu.Items
                    static
                    className="absolute right-0 w-52 mt-4 origin-top-right origin-top-right bg-zinc-300 dark:bg-zinc-900 border border-zinc-200 divide-y divide-zinc-100 rounded-md shadow-lg outline-none"
                  >
                  ...
                  <Menu.Items
                    static
                    className="absolute right-0 w-40 mt-4 origin-top-right origin-top-right bg-zinc-300 dark:bg-zinc-900 border border-zinc-200  divide-zinc-100 rounded-md shadow-lg outline-none"
                  >
                    <div className="py-1">
                      <Menu.Item>
                        {({ active }) => (
