...
const FavouriteSidePanel = () => {
  return (
    <div className="z-50 fixed right-0 top-0 max-w-xs w-full h-full px-6 py-4 transition duration-300 transform overflow-y-auto bg-white border-l-2 border-gray-300">
...
export default FavouriteSidePanel